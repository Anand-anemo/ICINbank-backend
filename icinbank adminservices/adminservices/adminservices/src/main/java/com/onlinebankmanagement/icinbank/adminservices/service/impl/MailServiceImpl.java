...
import com.onlinebankmanagement.icinbank.adminservices.model.Account;
...
public void sendAuthorizedEmail(String username) throws EmailException {
	    ...
	    mail.setAuthenticator(new DefaultAuthenticator("icinbank.nor===ply@gmail.com", "icin@0001155"));
	...
	public void sendAuthorizeCancelEmail(String username) throws EmailException {
		    ...
		    mail.setHostName("smtp.gmail.com");
		    mail.setSmtpPort(465);
		    mail.setAuthenticator(new DefaultAuthenticator("icinbank.norep====ly@gmail.com", "icin@---1155"));
